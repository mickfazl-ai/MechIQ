...
const CustomTooltip = ({ active, payload, label }) => {
  if (active && payload && payload.length) {
    return (
      <div style={{ background: "#FFFFFF", border: "1px solid #1a2f2f", borderRadius: 8, padding: "10px 14px" }}>
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  th { background: #F9FAFB; color: #1976D2; padding: 8px 10px; text-align: left; font-size: 10px; text-transform: uppercase; letter-spacing: 0.05em; }
  td { padding: 7px 10px; border-bottom: 1px solid #f0f0f0; }
  tr:nth-child(even) td { background: #fafafa; }
  .rec { display: inline-block; padding: 4px 14px; border-radius: 20px; font-weight: 700; font-size: 12px; }
  .rec.Keep { background: #F0FDF4; color: #15803D; }
  ...
  return (
    <div style={{ fontFamily: "Barlow, sans-serif", color: "#1a2b3c", padding: "24px 28px", maxWidth: 1100 }}>
      <style>{`
        ...
        .dep-input:focus { border-color: #1976D2 !important; outline: none; box-shadow: 0 0 0 3px rgba(0,171,228,0.1); }
          ...
          <div style={cardStyle}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
              ...
              <button
                ...
                disabled={aiLoading}
                style={{ padding: "8px 18px", fontSize: 12, fontWeight: 700, borderRadius: 6, border: "none", background: aiLoading ? "#E5E7EB" : `linear-gradient(135deg, ${CYAN}, #0090a8)`, color: aiLoading ? "#8fa8a8" : "#000", cursor: aiLoading ? "not-allowed" : "pointer", fontFamily: "Barlow, sans-serif" }}
              >
