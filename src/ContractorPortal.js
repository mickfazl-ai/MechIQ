...
const CSS = `
  ...
  .cp-btn { padding:11px 24px; background:linear-gradient(135deg,#1976D2,#0096b8); color:#fff; border:none; border-radius:8px; font-size:14px; font-weight:700; cursor:pointer; font-family:inherit; transition:all 0.18s; }
...
function LoginScreen({ onLogin }) {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'linear-gradient(160deg,#F3F4F6,#F3F4F6)', display:'flex', alignItems:'center', justifyContent:'center', padding:20 }}>
      <div style={{ background:'rgba(255,255,255,0.03)', border:'1px solid rgba(25,118,210,0.2)', borderTop:'2px solid #1976D2', borderRadius:16, padding:'40px 36px', width:'100%', maxWidth:420, backdropFilter:'blur(20px)', boxShadow:'0 0 60px rgba(25,118,210,0.08)' }}>
        ...
        <button onClick={handle} disabled={busy} style={{ width:'100%', padding:'13px', background:busy?'rgba(25,118,210,0.4)':'linear-gradient(135deg,#1976D2,#0096b8)', color:'#fff', border:'none', borderRadius:8, fontSize:14, fontWeight:700, cursor:busy?'not-allowed':'pointer', fontFamily:'inherit', transition:'all 0.2s', boxShadow:'0 0 24px rgba(25,118,210,0.25)' }}>
