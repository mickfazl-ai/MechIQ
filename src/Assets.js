...
function Toasts({ toasts }) {
  const P = { success: ['var(--green)','rgba(0,255,136,0.08)',''], error: ['var(--red)','rgba(255,51,102,0.08)',''], warning: ['var(--amber)','rgba(255,170,0,0.08)',''], info: ['#1976D2','rgba(0,212,255,0.08)','ℹ'] };
  return (
