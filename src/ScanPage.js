...
const CSS = `
  ...
  .sp { min-height:100vh; background:#F3F4F6; color:#111827; font-family:'Barlow',sans-serif; display:flex; flex-direction:column; align-items:center; padding:20px 14px 60px; }
  .sp-logo { font-family:'Barlow Condensed',sans-serif; font-size:22px; font-weight:900; letter-spacing:5px; color:#111827; margin-bottom:16px; }
  .sp-logo em { color:#1976D2; font-style:normal; }
  .sp-card { background:#fff; border:1px solid #E5E7EB; border-top:3px solid #1976D2; border-radius:10px; width:100%; max-width:440px; padding:22px 18px; box-shadow:0 4px 20px rgba(0,0,0,0.08); margin-bottom:14px; }
  ...
  .sp-asset-name { font-family:'Barlow Condensed',sans-serif; font-size:26px; font-weight:800; text-align:center; margin-bottom:4px; color:#111827; }
  ...
  .sp-btn-s { background:#f8fafc; color:#334155; border:1px solid #E5E7EB; }
  ...
  .sp-form-head { display:flex; justify-content:space-between; align-items:center; margin-bottom:14px; padding-bottom:12px; border-bottom:1px solid #E5E7EB; }
  .sp-form-title { font-family:'Barlow Condensed',sans-serif; font-size:18px; font-weight:800; text-transform:uppercase; letter-spacing:1px; color:#111827; }
  .sp-form-title em { color:#1976D2; font-style:normal; }
  .sp-back { background:none; border:1px solid #E5E7EB; border-radius:6px; padding:5px 12px; color:#64748b; cursor:pointer; font-size:12px; font-family:'Barlow',sans-serif; }
  ...
  .sp-asset-tag strong { color:#111827; font-weight:700; }
  ...
  .sp-inp { width:100%; padding:10px 11px; background:#f8fafc; border:1px solid #E5E7EB; border-radius:6px; color:#111827; font-size:14px; font-family:'Barlow',sans-serif; outline:none; box-sizing:border-box; }
  .sp-inp:focus { border-color:#1976D2; background:#fff; }
  .sp-inp::placeholder { color:#cbd5e1; }
  .sp-select { width:100%; padding:10px 11px; background:#f8fafc; border:1px solid #E5E7EB; border-radius:6px; color:#111827; font-size:14px; font-family:'Barlow',sans-serif; outline:none; }
  ...
  /* Check items */
  .sp-check { display:flex; align-items:flex-start; gap:10px; padding:11px 12px; background:#f8fafc; border:1.5px solid #E5E7EB; border-radius:8px; cursor:pointer; margin-bottom:6px; transition:all 0.1s; }
  ...
  .sp-defect-comment { width:100%; margin-top:6px; padding:8px 10px; background:#fff; border:1.5px solid rgba(239,68,68,0.3); border-radius:6px; font-size:12px; font-family:'Barlow',sans-serif; color:#111827; resize:vertical; outline:none; box-sizing:border-box; }
  ...
  .sp-photo-preview { position:relative; border-radius:8px; overflow:hidden; border:1.5px solid #E5E7EB; }
  ...
  .sp-item-inp { padding:8px 10px; background:#f8fafc; border:1.5px solid #E5E7EB; border-radius:6px; color:#111827; font-size:13px; font-family:'Barlow',sans-serif; outline:none; width:110px; }
  .sp-item-inp:focus { border-color:#1976D2; }

  /* Parts table */
  .sp-parts { width:100%; border-collapse:collapse; font-size:12px; margin-top:8px; }
  .sp-parts th { padding:5px 8px; text-align:left; color:#94a3b8; font-size:10px; text-transform:uppercase; letter-spacing:0.5px; border-bottom:1px solid #E5E7EB; }
  .sp-parts td { padding:7px 8px; border-bottom:1px solid #F3F4F6; color:#334155; }
  ...
  .sp-ok-msg { font-size:17px; font-weight:700; margin-bottom:5px; color:#111827; }
  ...
  .sp-tmpl-item { padding:13px 14px; background:#f8fafc; border:1.5px solid #E5E7EB; border-radius:8px; cursor:pointer; transition:all 0.1s; }
  .sp-tmpl-item:hover { background:#fff; border-color:#1976D2; box-shadow:0 2px 8px rgba(14,165,233,0.1); }
  .sp-tmpl-name { font-size:14px; font-weight:700; color:#111827; margin-bottom:2px; }
